...
const Login = () => {
    ...
    return (
        <div className='container w-50 mx-auto login-container'>
            ...
            {errorElement}
            <p className='mx-auto w-75 text-white'>New to Rabiul Car Store? <Link to="/signup" className='text-white fw-bolder pe-auto text-decoration-none' onClick={navigateSignUp}>Please Register</Link> </p>
